...
class SongContentsControllerTest < ActionController::TestCase
  ...
  test "should create song_content" do
    assert_difference('SongContent.count') do
      post :create, song_content: { album_title: @song_content.album_title, content: @song_content.content, origin_url: @song_content.origin_url, singer: @song_content.singer, song_title: @song_content.song_title }
    end
  ...
  test "should update song_content" do
    patch :update, id: @song_content, song_content: { album_title: @song_content.album_title, content: @song_content.content, origin_url: @song_content.origin_url, singer: @song_content.singer, song_title: @song_content.song_title }
    assert_redirected_to song_content_path(assigns(:song_content))
  end
