class SongContentsController < ApplicationController
  ...
  ##########################################
  # get Origin_URL from View
  # deliver Origin_URL to ContentParser
  # get Parsed Instance from Controller
  # deliver Parsed Instance to Model
  ##########################################
  ...
  private
    ...
    def song_content_params
      params.require(:song_content).permit(:origin_url, :singer, :album, :content, :song)
    end
end
